...
# only thing different is under this

if __name__ == "__main__":
    companyimage = 'company_logo.png'
    secretmessage = 'TARGET:192.168.1.50'
    outputimage = 'compay_logo.png'

    print("\nHiding Message: " , secretmessage)
    print("Extracted Data:" , extract_message(outputimage))